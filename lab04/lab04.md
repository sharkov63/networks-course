...
#### Демонстрация работы
* `python3 lab04/proxy_nocache.py --port <PORT>`
* ![](./images/1_StartServer.png)
* ![](./images/2_GetRequest.png)
* ![](./images/3_GetError.png)
* ![](./images/4_PostRequest.png)
* ![](./images/5_PostResult.png)
...
#### Демонстрация работы
* Запуск `python3 lab04/proxy_cache.py --port <PORT> --cache-dir <CACHE_DIR>`
* ![](./images/6_StartCacheServer.png)
* ![](./images/7_CacheMiss.png)
* ![](./images/8_CacheHit.png)
* ![](./images/9_FileOnDisk.png)
...
#### Демонстрация работы
* `python3 lab04/proxy_blacklist.py --port 8888 --blacklist lab04/blacklist`
* Файл `blacklist`: в каждой строчке регулярное выражение. Если доменное имя матчится с хотя бы одним регулярным выражением в файле, то оно в blacklist.
* ![](./images/10_StartBlacklistServer.png)
* ![](./images/11_NoBlacklist.png)
* ![](./images/12_Blacklist1.png)
* ![](./images/13_Blacklist2.png)
...
1. Выполните nslookup, чтобы получить IP-адрес какого-либо веб-сервера в Азии
   - У `tenki.jp` IP-адрес `153.125.234.6`: ![](./images/T1_tenki_jp.png)
2. Выполните nslookup, чтобы определить авторитетные DNS-серверы для какого-либо университета в Европе
   - Для vub.be авторитетный DNS-сервер - ns3.vub.ac.be: ![](./images/T2_vub_be.png)
3. Используя nslookup, найдите веб-сервер, имеющий несколько IP-адресов. Сколько IP-адресов имеет веб-сервер вашего учебного заведения?
   - ![](./images/T3_many_ips.png)
   - Один IP-адрес: ![](./images/T4_spbu.png)
